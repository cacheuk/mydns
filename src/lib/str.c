 ...
 **************************************************************************************************/
char *mydns_class_str(dns_class_t c) {
	static char buf[4];

	switch (c) {
	case DNS_CLASS_UNKNOWN:
		return ("UNKNOWN");
	case DNS_CLASS_IN:
		return ("IN");
 ...
 **************************************************************************************************/
char *mydns_qtype_str(dns_qtype_t qtype) {
	static char buf[4];
 ...
 **************************************************************************************************/
char *mydns_opcode_str(dns_opcode_t opcode) {
	static char buf[4];
 ...
 **************************************************************************************************/
char *mydns_rcode_str(dns_rcode_t rcode) {
	static char buf[4];

	switch (rcode) {
	case DNS_RCODE_UNKNOWN:
		return ("UNKNOWN");
 ...
 **************************************************************************************************/
char *mydns_section_str(datasection_t section) {
	switch (section) {
	case QUESTION:
		return ("QUESTION");
	case ANSWER:
 ...
 **************************************************************************************************/
int hinfo_parse(char *hinfo, char *cpu, char *os, size_t destlen) {
	register char *s, *d;
