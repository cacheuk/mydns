 ...
 **************************************************************************************************/
static int sortcmp(RR *rr1, RR *rr2) {
 ...
 **************************************************************************************************/
static RR *rrsort(RR *head, int (*compar)(RR *, RR *)) {
 ...
 **************************************************************************************************/
static inline void sort_rrlist(RRLIST *rrlist, int (*compar)(RR *, RR *)) {
	register RR *node;
 ...
 **************************************************************************************************/
static inline void load_balance(TASK *t, RRLIST *rrlist, datasection_t section,
		int sort_level) {
 ...
 **************************************************************************************************/
static inline void _sort_a_recs(TASK *t, RRLIST *rrlist, datasection_t section,
		int sort_level) {
	register RR *node;
...
/**************************************************************************************************
 ...
 If any of the RR's have nonzero "aux" values, do load balancing, else do round robin.
 **************************************************************************************************/
void sort_a_recs(TASK *t, RRLIST *rrlist, datasection_t section) {
	register RR *node;
...
/**************************************************************************************************
 ...
 equal.
 **************************************************************************************************/
void sort_mx_recs(TASK *t, RRLIST *rrlist, datasection_t section) {
	register RR *node;
 ...
 **************************************************************************************************/
static inline int sort_srv_priority(TASK *t, RRLIST *rrlist,
		datasection_t section, uint32_t priority, int sort_level, int order) {
	register RR *node; /* Current node */
 ...
 **************************************************************************************************/
static inline void _sort_srv_recs(TASK *t, RRLIST *rrlist,
		datasection_t section, int sort_level) {
	register RR *node; /* Current node */
	...
	for (node = rrlist->head; node; node = node->next)
		if (RR_IS_SRV(node) && node->sort_level == sort_level && !node->sort2) {
			...
			while (sort_srv_priority(t, rrlist, section, priority, sort_level,
					order++))
				/* DONOTHING */;
		}
}
...
/**************************************************************************************************
 SORT_SRV_RECS
 **************************************************************************************************/
void sort_srv_recs(TASK *t, RRLIST *rrlist, datasection_t section) {
	register RR *node; /* Current node */
